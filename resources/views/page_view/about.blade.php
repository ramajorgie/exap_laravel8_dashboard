...
@section('container')
    ...
    <section id="about" class="about-section pt-120">
      <div class="shape shape-2">
        <img src="{{URL::asset('assets_view')}}/img/shapes/shape-2.svg" alt="" />
      </div>
      <div class="container">
        <div class="row">
          <div class="col-xl-10 col-lg-11 mx-auto">
            <div class="about-content text-center mb-55">
              <div class="section-title mb-30">
                <span class="wow fadeInDown" data-wow-delay=".2s">About Compony</span>
        ...
        <div class="row">
          <div class="col-xl-8 mx-auto">
            <div class="section-title text-center mb-55">
              ...
              <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s">What We Provide</h2>
