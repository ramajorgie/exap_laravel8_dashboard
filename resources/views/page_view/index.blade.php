...
@section('container')
      ...
      <section class="we-do-section pt-150">
        <div class="shape shape-1">
          <img src="{{URL::asset('assets_view')}}/img/shapes/shape-1.svg" alt="" />
        </div>
        <div class="container">
          <div class="row">
            ...
            <div class="col-xl-6 offset-xl-6 col-lg-8 col-md-10">
              <div class="faq-content-wrapper pt-90 pb-90">
                <div class="section-title">
                  ...
                  <h2 class="text-white mb-35 wow fadeInUp" data-wow-delay=".4s">Get Every Single Answers There if you want</h2>
                </div>
                <div class="faq-wrapper accordion" id="accordionExample">
                  <div class="faq-item mb-20">
                    <div id="headingOne">
                      <h5 class="mb-0">
                        <button class="faq-btn btn" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">What is an academic medical center? <i class="lni"></i></button>
                      </h5>
                    </div>
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <div class="faq-content">
                        Lorem ipsum dolor sit amet, consetet Lorem ipsum dolor sit amet, consetet sadipscing elitr, sed dinonumy eirmod tempor invidunt. sadipscing elitr, sed dinonumy eirmod tempor invidunt. Lorem ipsum dolor sit amet,
                        consetet Lorem ipsum dolor.
                      </div>
                    </div>
                  </div>
                  <div class="faq-item mb-20">
                    <div id="headingTwo">
                      <h5 class="mb-0">
                        <button class="faq-btn btn collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">What is an academic medical center? <i class="lni"></i></button>
                      </h5>
                    </div>
                  ...
                  <div class="faq-item mb-20">
                    <div id="headingThree">
                      <h5 class="mb-0">
                        <button class="faq-btn btn collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">What is a medical student? <i class="lni"></i></button>
                      </h5>
                    </div>
                  ...
                  <div class="faq-item">
                    <div id="headingFour">
                      <h5 class="mb-0">
                        <button class="faq-btn btn collapsed" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">How are residents supervised? <i class="lni"></i></button>
                      </h5>
                    </div>
          ...
          <div class="row">
            <div class="col-xl-7">
              <div class="section-title">
                ...
                <p class="mb-35">
                  Lorem ipsum dolor sit amet, consetetur sadiping elitr, sed dinonumy <br class="d-none d-lg-block" />
            ...
            <div class="col-xl-8">
              <div class="subscribe-wrapper">
                ...
                <div class="subscribe-links">
                  <ul>
                    <li>
                      <a href="#"><i class="lni lni-phone-set"></i> <span>+034895903478</span> </a>
                    </li>
                    <li>
